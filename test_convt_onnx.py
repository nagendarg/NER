...
def main(args):
    ...
    with torch.no_grad():
        for step_idx, input_data_item in tqdm(enumerate(test_data_loader)):
            ...
            #print('input_data_item', input_data_item)
            # For easier debug.
            ...
            '''
            # Export the model
            #x_ip = **input_data_item
            x = []
            torch.onnx.export(pick_model, x, 'onnx_model.onnx', export_params=True, opset_version=10, do_constant_folding=True,  
